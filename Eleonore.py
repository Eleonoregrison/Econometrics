...
for year in range(years + 1):
    ...
    axs[year].set_title(f'Distribution de Year pour l\'année {year_0 + year}')
...
X = df[colomns].values  # Remplace 1 par la première colonne de données pertinentes si besoin
...
# +
mean_trajectories = df.groupby('Cluster')[columns].mean()  # Moyenne des trajectoires par cluster
